    ...
    >
      ...
      >
        ...
        >
          ...
          <Text>
            I'm{' '}
            <Text as="span" color="pink.600" fontWeight="bold">
              Rishi Srivastava{' '}
            </Text>{' '}
            from India. I'm in final year of BSc at Prof. Rajendra Singh (Rajju
            Bhaiya) University, Prayagraj.
          </Text>
          <Text>
            I started polishing my web dev skills and developed 5 projects using
            React, Typescript and HTML/CSS. Being comfortable with code allows
            me to rapidly prototype and validate experiences.
          </Text>
        </Box>
        <Box
          as={motion.div}
          ...
          justifyContent="center"
        >
          <Image src={personWorking} alt="Rishi Srivastava" boxSize="100%" />
        </Box>
      </Flex>
    </Box>
  );
